...
<link href="${pageContext.request.contextPath}/css/register.css"
	rel="stylesheet" type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/errorcss.css"></link>
    ...
    <script type="text/javascript">
      $(function() {
    	  $('#username').on("blur",function(){
    		  ...
    		  $.ajax({
    			  url : '${pageContext.request.contextPath}/user_registcheck.action', 
    			  type : 'POST',
    			  dataType : "json",
    			  data:{
    				  username:username
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" method="post" novalidate="novalidate" action="${pageContext.request.contextPath}/user_regist.action">
						<table>
							<tbody>
								<tr>
									<th><span class="requiredField">*</span>用户名:</th>
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20"><span ><s:fielderror fieldName="username" ></s:fielderror></span>
								...
								<tr>
									...
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off"><span><s:fielderror fieldName="password"></s:fielderror></span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200"><span><s:fielderror fieldName="email"></s:fielderror></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>手机:</th>
									<td><input type="text" id="phone" name="phone"
										class="text" maxlength="200"><span><s:fielderror fieldName="phone"></s:fielderror></span></td>
								</tr>
								<tr>
									<th>姓名:</th>
									<td><input type="text" name="name" class="text"
										maxlength="200"><span><s:fielderror fieldName="name"></s:fielderror></span></td>
								</tr>
								<tr>
									<th>性别:</th>
								...
								<tr>
									...
									<td><input type="text" name="addr" class="text"
										maxlength="200"><span><s:fielderror fieldName="addr"></s:fielderror></span></td>
								</tr>
								<tr>
									...
									<input type="text"
											...
											<img 
												...
												title="点击更换验证码"></span><input type='text' hidden="hidden" id='rightcheckcode' >
