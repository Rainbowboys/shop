...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					...
					<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_removeCart.action?pid=${orderItem.product.pid }" class="delete">删除</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
			...
			<form id="orderForm" action="${pageContext.request.contextPath}/order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="order.user.addr" type="text" style="width:350px" value="${userbean.addr }" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="order.user.username" type="text"  style="width:150px" value="${userbean.name }" />
								<br /> 
							联系方式：<input name="order.user.phone" type="text" value="${userbean.phone }" style="width:150px" />
