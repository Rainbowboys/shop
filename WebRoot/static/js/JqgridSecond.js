jQuery(function($) {
	...
	jQuery(grid_selector).jqGrid({
		// direction: "rtl",
		url : 'categorysecond_findCategorySecondByPage.action',
		mtype : "post",
		datatype : "json",
		height : 300,
		colNames : [ ' ','CSID','CSName','CID'],
		colModel : [ {
			name : 'myac',
			index : '',
			width : 80,
...
//			hidden:true
	...
	, {
		...
		edittype:"select",
		editoptions: {
			dataUrl:$path_base + "/category_getCategoryList.action"
		...
		editurl : $path_base + "/categorysecond_operCategorySecond.action",// nothing is saved
		caption : "二级分类列表",
